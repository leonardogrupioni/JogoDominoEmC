        ...
        switch (escolha) {
            case 1: //jogar com submenu
                ...
                do{
                    ...
                    switch (jogadores) {
                    case 1: ; //2 jogadores
                        int primeiroAJogar = conferirPecaInicial(pecas); //recebe 1 ou 2
                        jogadorInicial(primeiroAJogar);
                        //imprimir a primeira mesa
                        //do while q funcionara sobre turnos
                        //fncao imprimir mesa req 08
                        //sub menu do jogador
                            //pecas do jogador
                            //comprar peca
                            // comprar pecas
                              /*  verificarCompraDePecas(pecas, turno);
                                break;        */
                            //sair
                        break;
